            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="pt-6 flex space-x-4">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-full bg-gradient-to-r from-[#2563eb] via-[#9333ea] to-[#db2777] text-white font-medium hover:opacity-90 transition-opacity shadow-md flex justify-center items-center"
                >
                  {loading ? (
